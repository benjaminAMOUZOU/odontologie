...
class Serialize:
    ...
    def get_maladies(self):
        ...
        elements = list()
        for item in elements_data:
            data = Patient(item['id'], item['libelle'], item['description'], item['created_at'], item['updated_at'])
            elements.append(data)
        return elements
    ...
    def get_consultations_type(self):
        elements_data = self.json_data['consultations_type']
        elements = list()
        for item in elements_data:
            data = Patient(item['id'], item['libelle'], item['created_at'], item['updated_at'])
            elements.append(data)
        return elements
    ...
    def get_consultations(self):
        ...
        elements = list()
        for item in elements_data:
            data = Patient(item['id'], item['observation'], item['created_at'], item['updated_at'])
            elements.append(data)
        return elements
    ...
    def get_consultation_maladie(self):
        ...
        elements = list()
        for item in elements_data:
            data = Patient(item['id'], item['debut_traitement'], item['fin_traitement'], item['traitement_reussi'], item['created_at'], item['updated_at'])
            elements.append(data)
        return elements
